...
# --------------------------------------------------------
# Based on: IsaacLabEnvs
# Copyright (c) 2018-2022, NVIDIA Corporation
# Licence under BSD 3-Clause License
# https://github.com/NVIDIA-Omniverse/IsaacLabEnvs/
# --------------------------------------------------------
...
#from isaaclab.utils.torch_ext import *
...
import leapfeels.learning.replay_buffer as replay_buffer
import leapfeels.learning.common_agent as common_agent 
...
class AMPAgent(common_agent.CommonAgent):
    ...
    def _load_config_params(self, config):
        ...
        #self._amp_observation_space = 102
